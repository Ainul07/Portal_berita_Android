...
import com.ain.beritaainul.response.BeritaItem;
...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "https://ainulyakintis17stimik.000webhostapp.com/images/" + berita.get(position).getFoto();
